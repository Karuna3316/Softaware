<%@ Page Title="" Language="C#" MasterPageFile="~/FDSS.master" AutoEventWireup="true" CodeFile="LocationList.aspx.cs" Inherits="LocationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                                ...
                                <div class="card" style="width: 100%; height: auto;">
                                    ...
                                    <div class="card-block" style="padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <div class="dt-responsive table-responsive" style="padding-left: 10px; padding-bottom: 10px;" data-bind="with: formDocument">
                                            <table id="tblfdss_Master" class="table table-striped table-bordered nowrap" data-bind="hidden: formDocument().lstLocationBindObj().length> 0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody data-bind="foreach: formDocument().lstLocationBindObj()" style="width: 100%;">
                                                    <tr>
    ...
    <script type="text/javascript">
        ...
        function Bindlocation() {
            $.ajax({
                ...
                url: "LocationList.aspx/getLocationList",
                dataType: "json",
                success: function (data) {

                    formDocument().lstLocationBindObj().constructor();
        ...
        function EditDate(itemI) {
            location.href = "Location.aspx?MasterID=" + itemI.getAttribute('MasterID');
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "LocationList.aspx/DeleteLocation",
                            data: "{lReqId : " + iInd + "}",
                            dataType: "json",
                            success: function (data) {
                                if (data.d != "") {
    ...
    <script type="text/javascript">
        ...
        var lstLocationObj = function () {
            var self = this;
            this.lstLocationBindObj = ko.observableArray([{
                MasterID: 0, Description: '', CreatedBy: '', UpdatedDate: ''
            }]);
        };
        formDocument = ko.observable(new lstLocationObj());
        ko.applyBindings(new lstLocationObj(), document.getElementById("tblfdss_Master"));
    </script>
