<%@ Page Title="" Language="C#" MasterPageFile="~/FDSS.master" AutoEventWireup="true" CodeFile="MakeList.aspx.cs" Inherits="MakeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                                ...
                                <div class="card" style="width: 100%; height: auto;">
                                    ...
                                    <div class="card-block" style="padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <div class="dt-responsive table-responsive" style="padding-left: 10px; padding-bottom: 10px;" data-bind="with: formDocument">
                                            <table id="tblfdss_Master" class="table table-striped table-bordered nowrap" data-bind="hidden: formDocument().lstMakeBindObj().length> 0" " style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody data-bind="foreach: formDocument().lstMakeBindObj()" style="width: 100%;">
                                                    <tr>
     ...
     <script type="text/javascript">
         ...
         function BindMake() {
             $.ajax({
                 ...
                 url: "MakeList.aspx/getMakeList",
                 dataType: "json",
                 success: function (data) {

                     formDocument().lstMakeBindObj().constructor();
         ...
         function EditDate(itemI) {
             location.href = "Make.aspx?MasterID=" + itemI.getAttribute('MasterID');
    ...
    <script type="text/javascript">
        ...
        var lstMakeObj = function () {
            var self = this;
            this.lstMakeBindObj = ko.observableArray([{
                MasterID: 0, Description: '', CreatedBy: '', UpdatedDate: ''
            }]);
        };
        formDocument = ko.observable(new lstMakeObj());
        ko.applyBindings(new lstMakeObj(), document.getElementById("tblfdss_Master"));
        </script>
