<%@ Page Title="" Language="C#" MasterPageFile="~/FDSS.master" AutoEventWireup="true" CodeFile="SupplierMasterList.aspx.cs" Inherits="SupplierMasterList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                                ...
                                <div class="card" style="width: 100%; height: auto;">
                                    ...
                                    <div class="card-block" style="padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <div class="dt-responsive table-responsive" style="padding-left: 10px; padding-bottom: 10px;" data-bind="with: formDocument">
                                            <table id="basic-btn" class="table table-striped table-bordered nowrap" data-bind="hidden: formDocument().lstsprObj().length > 0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody data-bind="foreach: lstsprObj" style="width: 100%;">
                                                    <tr>
                                                        <td style=""><span data-bind="text:SupplierName "></span></td>
                                                        <td style=""><span data-bind="text:GstNo"></span></td>
                                                        <td style="word-wrap: break-word; white-space: pre-line; text-align:left;"><span data-bind="text:Address"></span></td>
                                                        <td style=""><span data-bind="text:CreatedBy"></span></td>
                                                        <td style=" text-align: center;"><span data-bind="text:UpdatedDate"></span></td>
                                                        <td style="text-align: center; ">

                                                            <button type="button" name="data" class="btn  btn-success" onclick="EditDate(this)" style="width: 90px; height: auto; background: #009933; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'SID': SID}"><i class="ti-pencil" style="font-size:16px;"></i>Edit</button>
                                                            <button type="button" name="data" class="btn  btn-success" onclick="DeleteDate(this)" style="width: 90px; height: auto; background: #FF7D7D; border: 1px solid #FF7D7D; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'SID': SID}"><i class="ti-trash" style="font-size:16px;"></i>Delete</button>
    ...
    <script type="text/javascript">
        ...
        function newReq() {
            location.href = "SupplierMaster.aspx";
        }
        ...
        function BindSupplier() {
            $.ajax({
                ...
                url: "SupplierMasterList.aspx/getsuppliermaster",
                dataType: "json",
                success: function (data) {
                    formDocument().lstsprObj().constructor();
        ...
        function EditDate(itemI) {
            location.href = "SupplierMaster.aspx?SID=" + itemI.getAttribute('SID');
        ...
        function DeleteDate(itemI) {
            var iInd = itemI.getAttribute('SID');
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "SupplierMasterList.aspx/deleteSupplierMaster",
                            data: "{lReqId : " + iInd + "}",
                            dataType: "json",
                            success: function (data) {
                                if (data.d != "") {
    ...
    <script type="text/javascript">
        var supplierobj = function () {
            var self = this;
            this.lstsprObj = ko.observableArray([{
                SID: 0, SupplierName: '', GstNo: '', Address: '', Updatedby: '', UpdatedDate: '', CreatedBy: ''
            }]);
        };
        formDocument = ko.observable(new supplierobj());
        ko.applyBindings(new supplierobj());
