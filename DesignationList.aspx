<%@ Page Title="" Language="C#" MasterPageFile="~/FDSS.master" AutoEventWireup="true" CodeFile="DesignationList.aspx.cs" Inherits="DesignationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                                ...
                                <div class="card" style="width: 100%; height: auto;">
                                    <div class="card-block"  style="padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <div class="dt-responsive table-responsive" style="padding-left: 10px; padding-bottom: 10px;" data-bind="with: formDocument">
                                            <table id="basic-btn" class="table table-striped table-bordered nowrap" data-bind="hidden: formDocument().lstDesiObj().length > 0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody data-bind="foreach: lstDesiObj" style="width: 100%;">
                                                    <tr>
                                                        <td style="text-align: left; width: 25%"><span data-bind="text: Designation"></span></td>
                                                        <td style=" width: 25%"><span data-bind="text: CreatedBy"></span></td>
                                                        <td style="text-align: center; width: 25%"><span data-bind="text: UpdatedDate"></span></td>
                                                        <td style="width: 25%; text-align: center;">
                                                            <button type="button" name="data" class="btn  btn-success" onclick="EditDate(this)" style="width: 90px; height: auto; background: #009933; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'DesignationID': DesignationID}"><i class="ti-pencil" style="font-size:16px;"></i>Edit</button>
                                                            <button type="button" name="data" class="btn  btn-success" onclick="DeleteDate(this)" style="width: 90px; height: auto; background: #FF7D7D; border: 1px solid #FF7D7D; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'DesignationID': DesignationID}"><i class="ti-trash" style="font-size:16px;"></i>Delete</button>
    ...
    <script type="text/javascript">
        ...
        function newReq() {
            location.href = "Designation.aspx";
        }
        ...
        function BindDesignation() {
            $.ajax({
                ...
                url: "DesignationList.aspx/getDesignation",
                dataType: "json",
        ...
        function EditDate(itemI) {
            ...
            location.href = "Designation.aspx?DesignationID=" + itemI.getAttribute('DesignationID');
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "DesignationList.aspx/DeleteDesignation",
                                data: "{lReqId : " + iInd + "}",
                                dataType: "json",
                                success: function (data) {
                                    if (data.d != "") {
    ...
    <script type="text/javascript">
        var lstDesignationObj = function () {
            var self = this;
            this.lstDesiObj = ko.observableArray([{
                DesignationID: 0, Designation: '', UpdatedBy: '', UpdatedDate: '', CreatedBy: ''
            }]);
        };
        formDocument = ko.observable(new lstDesignationObj());
        ko.applyBindings(new lstDesignationObj());
    </script>
</asp:Content>
