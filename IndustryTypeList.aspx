<%@ Page Title="" Language="C#" MasterPageFile="~/FDSS.master" AutoEventWireup="true" CodeFile="IndustryTypeList.aspx.cs" Inherits="IndustryTypeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                <h1 style="padding:5px 0px 5px 10px;">Industry Type</h1>
                                            </div>
                                            <div class="col-sm-6">
                                ...
                                <div class="card" style="width: 100%; height: auto;">
                                    <div class="card-block" style="padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <div class="dt-responsive table-responsive" style="padding-left: 10px; padding-bottom: 10px;" data-bind="with: formDocument">
                                            <table id="tblfdss_Master" class="table table-striped table-bordered nowrap" data-bind="hidden: formDocument().lstIndustryTypeBindObj().length> 0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 25%;">Industry Type</th>
                                                ...
                                                <tbody data-bind="foreach: formDocument().lstIndustryTypeBindObj()" style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 25%;"><span data-bind="text: Description "></span></td>
                                                        <td style="width: 25%; text-align: left;"><span data-bind="text: CreatedBy"></span></td>
                                                        <td style="width: 25%; text-align: center;"><span data-bind="text: UpdatedDate"></span></td>

                                                        <td style="text-align: center; width: 25%;">

                                                            <button type="button" name="data" class="btn  btn-success" onclick="EditDate(this)" style="width: 90px; height: auto; background: #009933; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'MasterID': MasterID}"><i class="ti-pencil" style="font-size: 16px;"></i>Edit</button>
                                                            <button type="button" name="data" class="btn  btn-success" onclick="DeleteDate(this)" style="width: 90px; height: auto; background: #FF7D7D; border: 1px solid #FF7D7D; margin-top: -3px; padding: 4px 11px;" data-bind="attr: { 'MasterID': MasterID}"><i class="ti-trash" style="font-size: 16px;"></i>Delete</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            document.getElementById("downloadButton").addEventListener("click", function () {
                ...
                var table = $('#tblfdss_Master').DataTable();
                ...
                XLSX.writeFile(wb, "Industry Type.xlsx");
            });
        ...
        function newReq() {
            location.href = "IndustryType.aspx";
        }


        function BindIndustryType() {
            $.ajax({

                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "IndustryTypeList.aspx/getIndustryTypeList",
                dataType: "json",
                success: function (data) {

                    formDocument().lstIndustryTypeBindObj().constructor();
                    if ($.fn.dataTable.isDataTable('#tblfdss_Master')) {
                        $('#tblfdss_Master').DataTable().clear().destroy();
                    }
                    ko.mapping.fromJS(data.d, null, formDocument);
                    $('#tblfdss_Master').DataTable({
                        "paging": true,
                        "ordering": false,
                        responsive: true,
        ...
        function EditDate(itemI) {
            location.href = "IndustryType.aspx?MasterID=" + itemI.getAttribute('MasterID');

        }

        function DeleteDate(itemI) {

            var iInd = itemI.getAttribute('MasterID');
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "IndustryTypeList.aspx/DeleteIndustryType",
                                data: "{lReqId : " + iInd + "}",
                                dataType: "json",
                                success: function (data) {
                                    if (data.d != "") {
    ...
    <script type="text/javascript">
        ...
        var lstIndustryTypeObj = function () {
            var self = this;
            this.lstIndustryTypeBindObj = ko.observableArray([{
                MasterID: 0,Description:'', MasterType: '', CreatedBy: '', UpdatedDate: ''
            }]);
        };
        formDocument = ko.observable(new lstIndustryTypeObj());
        ko.applyBindings(new lstIndustryTypeObj(), document.getElementById("tblfdss_Master"));
    </script>
