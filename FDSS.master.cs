...
public partial class Master_FDSS : System.Web.UI.MasterPage
{
    ...
    private void GenerateMenuItems()
    {
        try
        {
            ...
            {
                dtMenus = DataAccess.GetMenus(oU.userId);
                ...
                if (dvMenus.Count > 0)
                {
                    ...
                    foreach (DataRow drMi in dt.Rows)
                    {
                        if (drMi["parentId"].ToString() == Convert.ToString(drMi["menuId"]))
                        {
                            ...
                            //lnk.ID = "lnk" + drMi["menuId"].ToString();
                        ...
                        else
                        {
                            ...
                            //lnkSub.ID = "lnk" + drMi["menuId"].ToString();
                            ...
                            if (dQry2 != null && dQry2.Count() > 0)
                            {
                                ...
                                foreach (DataRow dr2 in dQry2)
                                {
                                    ...
                                    //lnkSub2.ID = "lnk" + dr2["menuId"].ToString();
                    ...
                    ULMenuList.Controls.Add(liMain);
                }
            }
        }
        catch (Exception ex)
        {
            throw ex;
            //UtilityClass.LogErrorToFile(ex.Message, "RESSApp.master", "GenerateMenuItems()", "High", "");
        }
    }
    ...
    protected void lnkMenu_Click(object sender, EventArgs e)
    {
        ...
        {
            //UtilityClass.LogErrorToFile(ex.Message, "RESSApp.master", "lnkMenu_Click()", "High", "");
            throw (ex);
        }
    }
}
